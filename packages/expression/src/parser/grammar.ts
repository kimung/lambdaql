...
export class Grammar {
  ...
  constructor() {
    ...
    this.parselets.addInfix(new BinaryParselet(TokenType.EQEQEQ,  90))
    this.parselets.addInfix(new BinaryParselet(TokenType.EQEQ,    90))
    this.parselets.addInfix(new BinaryParselet(TokenType.NOTEQEQ, 90))
    this.parselets.addInfix(new BinaryParselet(TokenType.NOTEQ,   90))
    this.parselets.addInfix(new BinaryParselet(TokenType.LTE,     90))
    this.parselets.addInfix(new BinaryParselet(TokenType.GTE,     90))
    this.parselets.addInfix(new BinaryParselet(TokenType.LT,      90))
    this.parselets.addInfix(new BinaryParselet(TokenType.GT,      90))
