...
export function visit<T>(expr: Expression, visitor: ExpressionVisitor<T>): T {
  switch (expr.kind) {
    case "NameExpression":
      return visitor.visitName(expr as NameExpression);
    case "ConstantExpression":
      return visitor.visitConstant(expr as ConstantExpression);
    case "BinaryExpression":
      return visitor.visitBinary(expr as BinaryExpression);
    case "UnaryExpression":
      return visitor.visitUnary(expr as UnaryExpression);
    case "PropertyExpression":
      return visitor.visitProperty(expr as PropertyExpression);
    case "MethodExpression":
      return visitor.visitMethod(expr as MethodExpression);
    case "FieldExpression":
      return visitor.visitField(expr as FieldExpression);
    case "ObjectLiteralExpression":
      return visitor.visitObjectLiteral(expr as ObjectLiteralExpression);
    case "LambdaExpression":
      return visitor.visitLambda(expr as LambdaExpression);
    case "ConditionalExpression":
      return visitor.visitConditional(expr as ConditionalExpression);
    case "NullishExpression":
      return visitor.visitNullish(expr as NullishExpression);
    case "ArrayLiteralExpression":
      return visitor.visitArrayLiteral(expr as ArrayLiteralExpression);
    case "TemplateLiteralExpression":
      return visitor.visitTemplateLiteral(expr as TemplateLiteralExpression);
    default:
